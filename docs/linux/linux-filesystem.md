...
Именно поэтому в Linux можно создать несколько имён, указывающих на один и тот же inode. Такие имена называются **жёсткими ссылками (hard links)**, но про это поговорим в другой раз.
